...
class FiberBag(models.Model):
    ...
    fiber = models.OneToOneField('materials.Fiber', on_delete=models.CASCADE, null=True, blank=True)
    bag = models.OneToOneField('materials.Bag', on_delete=models.CASCADE, null=True, blank=True)
    fibric = models.OneToOneField('materials.Fabric', on_delete=models.CASCADE, null=True, blank=True)
